...
Caso venha ocorrer o erro

/usr/bin/env: php: Arquivo ou diretório não encontrado

Foi resolvido executando o seguinte comando
...
wizard_module(){
   ...
   then
      ...
      wget https://github.com/cerebrumgit/magento1-telencephalon-php${phpversion_rpl}/archive/master.zip
      unzip master.zip
      cp -Rv magento1-telencephalon-php${phpversion_rpl}-master/* .
      rm -fr master.zip magento1-telencephalon-php${phpversion_rpl}-master
